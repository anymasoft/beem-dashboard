            ...
            <div className='space-y-8'>
              ...
              <div className='space-y-6'>
                <h1 className='text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-6xl'>
                  Перестаньте угадывать. Публикуйте описания, которые пройдут модерацию.
                </h1>

                <p className='text-muted-foreground mx-auto max-w-2xl text-balance lg:text-xl'>
                  Не нужно переделывать описания товаров месяцами. Проверьте описание за 10 секунд, исправьте ошибки и сразу публикуйте на маркетплейсе без отклонений.
                </p>
              </div>
